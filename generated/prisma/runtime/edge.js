...
var Fe = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
  ...
  si = (e, t, r, n) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let i of Ea(t))
        !xa.call(e, i) && i !== r && lr(e, i, { get: () => t[i], enumerable: !(n = wa(t, i)) || n.enumerable });
    return e;
  };
var Qe = (e, t, r) => (
    (r = e != null ? ya(ba(e)) : {}),
...
function Xa(e) {
  let t = { color: Ui[Za++ % Ui.length], enabled: Tt.enabled(e), namespace: e, log: Tt.log, extend: () => {} },
    r = (...n) => {
          ...
          (v = 0),
            ...
            d < 0
              ? ((ae = k[0]),
                ...
                D < F && R.unshift(0),
                r(k, R, F, l),
                d == -1 && ((F = k.length), (d = t($, k, ue, F)), d < 1 && (v++, r(k, ue < F ? sr : $, F, l))),
                (F = k.length))
              : d === 0 && (v++, (k = [0])),
            (B[h++] = v),
  ...
  if (
    ...
    if (!h[0]) g = A ? '0p+0' : '0';
      ...
      if (
        (s < 0
          ? o--
          : ((e = new S(e)), (e.d = h), (e.e = o), (e = q(e, v, r, n, 0, i)), (h = e.d), (o = e.e), (d = uo)),
        (s = h[r]),
        (a = i / 2),
        (d = d || h[r + 1] !== void 0),
        (d =
...
var Cu = Qe(Zi());
var Au = { red: ze, gray: Bi, dim: mr, bold: pr, underline: Mi, highlightSource: (e) => e.highlight() },
...
function Ou(e) {
  ...
  for (let n of e) {
    ...
    let i = `${n.selectionPath.join('.')}:${n.argumentPath.join('.')}`,
      o = t.get(i);
    o
      ? t.set(i, { ...n, argument: { ...n.argument, typeNames: Du(o.argument.typeNames, n.argument.typeNames) } })
      : t.set(i, n);
  }
...
function Fr({ args: e, errors: t, errorFormat: r, callsite: n, originalMethod: i, clientVersion: o, globalOmit: s }) {
  ...
  let { message: l, args: d } = Nr(a, r),
    g = Ar({ message: l, callsite: n, originalMethod: i, showColors: r === 'pretty', callArguments: d });
...
function Wr({ error: e, user_facing_error: t }, r, n) {
  return t.error_code
    ? new re(yc(t, n), { code: t.error_code, clientVersion: r, meta: t.meta, batchRequestIdx: t.batch_request_idx })
...
var ms = (e) => (Array.isArray(e) ? e : e.split('.')),
  ...
  fs = (e, t, r) => ms(t).reduceRight((n, i, o, s) => Object.assign({}, jn(e, s.slice(0, o)), { [i]: n }), r);
function Tc(e, t) {
